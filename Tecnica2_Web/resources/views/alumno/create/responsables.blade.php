			...
			<tbody>
					...
					<td>
						<div class="form-row">
							<div class="col">
								...
								<input type="text" id="apell_mad" name="apell_mad" required class="form-control" placeholder="Apellido" maxlength="50">
							</div>
							<div class="col">
								<label for="nomb_mad">Nombre/s:</label>
								<input type="text" id="nomb_mad" name="nomb_mad" required class="form-control" placeholder="Nombre" maxlength="50">
							</div>
						</div>    
						...
						<div class="row container-fluid">
							...
							<div class="col-5 row">
								...
								&nbsp; &nbsp;
								<input type="text" id="naciona_mad" name="naciona_mad" required class="form-control col"  maxlength="50">
							</div>
							&nbsp; &nbsp;
							<div class="col">
				...
				<tr>
					...
					<div class="form-row">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="tipdocument_mad" name="tipdocument_mad" placeholder="Tipo de Doc." maxlength="15">
							<input type="number" class="form-control" id="nrodocument_mad" name="nrodocument_mad" placeholder="Nro de Doc." min="0" max="999999999999999">
						</div>
						</div>
						<div class="col">
						&nbsp; &nbsp; 
				...
				<tr>
					...
					<div class="form-row align-middle row">
						...
						<div class="col-5">
							<div class="input-group">
								<input type="text" class="form-control w-50" id="callenombre_mad" name="callenombre_mad" placeholder="Calle" maxlength="50">
								<input type="number" class="form-control" id="callenro_mad" name="callenro_mad" placeholder="N°" min="0" max="99999"> 
							</div>
						</div>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="number" id="piso_mad" name="piso_mad" class="form-control col-8" min="-200" max="200">
						</div>
						<div class="col row">
							<label for="torre_mad" class="col-form-label">Torre:</label>
							&nbsp; &nbsp;
							<input type="number" id="torre_mad" name="torre_mad" class="form-control col-9" maxlength="15"> 
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col row">
								...
								<input type="text" id="dpto_mad" name="dpto_mad" class="form-control col-8" maxlength="15">
							</div>
							<div class="col row">
								<label for="distrito_mad" class="col-form-label">Distrito:</label>&nbsp;&nbsp;
								<input type="text" id="distrito_mad" name="distrito_mad" class="form-control col-8" maxlength="50">
							</div>
							<div class="col row">
								<label for="provincia_mad" class="col-form-label">Provincia:</label>&nbsp;&nbsp;
								<input type="text" id="provincia_mad" name="provincia_mad" class="form-control col-8" maxlength="50">
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col row">
								...
								<input type="text" id="localidad_mad" name="localidad_mad" class="form-control col" maxlength="50">
							</div>
							&nbsp; &nbsp;
							
							<div class="col row">
								<label for="codpostal_mad" class="col-form-label">Cod. Postal:</label>&nbsp;&nbsp;
								<input type="number" id="codpostal_mad" name="codpostal_mad" class="form-control col" min="-99999" max="99999">
							</div>
					...
					<div class="container-fluid">
						<div class="row form group">
								...
								<div class="form-row">
									<div class="col">
										<div class="input-group">
											...
											<input type="text" id="telefono_mad" name="telefono_mad" placeholder="Teléfono" class="form-control" maxlength="25">
											<input type="text" id="telefonocelular_mad" name="telefonocelular_mad" placeholder="Teléfono Celular" class="form-control" maxlength="25">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-5">
								<input type="text" class="form-control" id="email_mad" name="email_mad" placeholder="ejemplo@gmail.com" aria-label="E-mail" aria-describedby="basic-addon2" maxlength="50">
							</div>
				...
				<tr>
					...
					<div class="form-row">
						...
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="text" id="profesion_mad" name="profesion_mad" class="form-control col-7" maxlength="50">
						</div>
					</div>
			...
			<tbody>
					...
					<td>
						<div class="form-row">
							<div class="col">
								...
								<input type="text" id="apell_pad" name="apell_pad" required class="form-control" placeholder="Apellido" maxlength="50">
							</div>
							<div class="col">
								<label for="nomb_pad">Nombre/s:</label>
								<input type="text" id="nomb_pad" name="nomb_pad" required class="form-control" placeholder="Nombre" maxlength="50">
							</div>
						</div>    
						...
						<div class="row container-fluid">
							...
							<div class="col-5 row">
								...
								&nbsp; &nbsp;
								<input type="text" id="naciona_pad" required name="naciona_pad" class="form-control col" maxlength="50">
							</div>
							&nbsp; &nbsp;
							<div class="col">
								&nbsp;&nbsp;¿Asistió a algún establecimiento educacional? &nbsp; &nbsp;
				...
				<tr>
					...
					<div class="form-row">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="tipdocument_pad" name="tipdocument_pad" placeholder="Tipo de Doc." maxlength="15">
							<input type="number" class="form-control" id="nrodocument_pad" name="nrodocument_pad" placeholder="Nro de Doc." min="0" max="999999999999999">
						</div>
						</div>
						<div class="col">
						&nbsp; &nbsp; 
				...
				<tr>
					...
					<div class="form-row align-middle row">
						...
						<div class="col-5">
							<div class="input-group">
								<input type="text" class="form-control w-50" id="callenombre_pad" name="callenombre_pad" placeholder="Calle"  maxlength="50">
								<input type="number" class="form-control" id="callenro_pad" name="callenro_pad" placeholder="N°" min="0"  max="99999">
							</div>
						</div>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="number" id="piso_pad" name="piso_pad" class="form-control col-8" min="-200" max="200">
						</div>
						<div class="col row">
							<label for="torre_pad" class="col-form-label">Torre:</label>
							&nbsp; &nbsp;
							<input type="number" id="torre_pad" name="torre_pad" class="form-control col-9" maxlength="15"> 
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col row">
								...
								<input type="text" id="dpto_pad" name="dpto_pad" class="form-control col-8" maxlength="15">
							</div>
							<div class="col row">
								<label for="distrito_pad" class="col-form-label">Distrito:</label>&nbsp;&nbsp;
								<input type="text" id="distrito_pad" name="distrito_pad" class="form-control col-8" maxlength="50">
							</div>
							<div class="col row">
								<label for="provincia_pad" class="col-form-label">Provincia:</label>&nbsp;&nbsp;
								<input type="text" id="provincia_pad" name="provincia_pad" class="form-control col-8" maxlength="50">
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col row">
								...
								<input type="text" id="localidad_pad" name="localidad_pad" class="form-control col" maxlength="50">
							</div>
							&nbsp; &nbsp;
							
							<div class="col row">
								<label for="codpostal_pad" class="col-form-label">Cod. Postal:</label>&nbsp;&nbsp;
								<input type="number" id="codpostal_pad" name="codpostal_pad" class="form-control col" min="-99999" max="99999">
							</div>
					...
					<div class="container-fluid">
						<div class="row form group">
								...
								<div class="form-row">
									<div class="col">
										<div class="input-group">
											...
											<input type="text" id="telefono_pad" name="telefono_pad" placeholder="Teléfono" class="form-control"  maxlength="25">
											<input type="text" id="telefonocelular_pad" name="telefonocelular_pad" placeholder="Teléfono Celular" class="form-control"  maxlength="25">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-5">
								<input type="text" class="form-control" id="email_pad" name="email_pad" placeholder="ejemplo@gmail.com" aria-label="E-mail" aria-describedby="basic-addon2"  maxlength="50">
							</div>
				...
				<tr>
					...
					<div class="form-row">
						...
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="text" id="profesion_pad" name="profesion_pad" class="form-control col-7" maxlength="50">
						</div>
					</div>
			...
			<tbody>
					...
					<td>
						<div class="form-row">
							<div class="col">
								...
								<input type="text" id="apell_tut" name="apell_tut" class="form-control" placeholder="Apellido" maxlength="50">
							</div>
							<div class="col">
								<label for="nomb_tut">Nombre/s:</label>
								<input type="text" id="nomb_tut" name="nomb_tut" class="form-control" placeholder="Nombre" maxlength="50">
							</div>
						</div>    
						...
						<div class="form-row">
							<div class="col">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="tipdocument_tut" name="tipdocument_tut" placeholder="Tipo de Doc." maxlength="15">
									<input type="number" class="form-control" id="nrodocument_tut" name="nrodocument_tut" placeholder="Nro de Doc." min=0 max="999999999999999">
								</div>
							</div>
							<div class="col">
								&nbsp; &nbsp; 
				...
				<tr>
					...
					<div class="form-row align-middle row">
						...
						<div class="col-5">
							<div class="input-group">
								<input type="text" class="form-control w-50" id="callenombre_tut" name="callenombre_tut" placeholder="Calle" maxlength="50">
								<input type="number" class="form-control" id="callenro_tut" name="callenro_tut" placeholder="N°" min="0" max="99999">
							</div>
						</div>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="number" id="piso_tut" name="piso_tut" class="form-control col-8" min="-200" max="200">
						</div>
						<div class="col row">
							<label for="torre_tut" class="col-form-label">Torre:</label>
							&nbsp; &nbsp;
							<input type="number" id="torre_tut" name="torre_tut" class="form-control col-9" maxlength="15"> 
						</div>
					</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col row">
								...
								<input type="text" id="dpto_tut" name="dpto_tut" class="form-control col-8" maxlength="15">
							</div>
							<div class="col row">
								<label for="distrito_tut" class="col-form-label">Distrito:</label>&nbsp;&nbsp;
								<input type="text" id="distrito_tut" name="distrito_tut" class="form-control col-8" maxlength="50">
							</div>
							<div class="col row">
								<label for="provincia_tut" class="col-form-label">Provincia:</label>&nbsp;&nbsp;
								<input type="text" id="provincia_tut" name="provincia_tut" class="form-control col-8" maxlength="50">
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col row">
								...
								<input type="text" id="localidad_tut" name="localidad_tut" class="form-control col" maxlength="50">
							</div>
							&nbsp; &nbsp;
							
							<div class="col row">
								<label for="codpostal_tut" class="col-form-label">Cod. Postal:</label>&nbsp;&nbsp;
								<input type="number" id="codpostal_tut" name="codpostal_tut" class="form-control col" min="-99999" max="99999">
							</div>
					...
					<div class="container-fluid">
						<div class="row form group">
								...
								<div class="form-row">
									<div class="col">
										<div class="input-group">
											...
											<input type="text" id="telefono_tut" name="telefono_tut" placeholder="Teléfono" class="form-control"  maxlength="25">
											<input type="text" id="telefonocelular_tut" name="telefonocelular_tut" placeholder="Teléfono Celular" class="form-control" maxlength="25">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-5">
								<input type="text" class="form-control" id="email_tut" name="email_tut" placeholder="ejemplo@gmail.com" aria-label="E-mail" aria-describedby="basic-addon2"  maxlength="50">
							</div>
				...
				<tr>
					...
					<div class="form-row">
						...
						<div class="col row">
							...
							&nbsp; &nbsp;
							<input type="text" id="profesion_tut" name="profesion_tut" class="form-control col-7" maxlength="50">
						</div>
					</div>
					...
					<td>
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" name="apelli_ret" id="apelli_ret" class="form-control" maxlength="50">
							</div>
							
							<div class="col">
								<label for="nombre_ret" class="form-label">Nombre/s</label>
								<input type="text" name="nombre_ret" id="nombre_ret" class="form-control" maxlength="50">
							</div>
							&nbsp; &nbsp;
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="tip_document_ret" name="tip_document_ret" placeholder="Tipo de Doc."  maxlength="15">
									<input type="number" class="form-control" id="nro_document_ret" name="nro_document_ret" placeholder="Nro de Doc." min="0" max="999999999999999">
								</div>
							</div>

							<div class="col">
								<input type="text" name="vinculo_alumno" id="vinculo_alumno" class="form-control" placeholder="Vínculo/Parentesco con el alumno" maxlength="50">
							</div>
						</div>
						<br>
					</td>
					...
					<td>
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" name="B_apelli_ret" id="B_apelli_ret" class="form-control" maxlength="50">
							</div>
							
							<div class="col">
								<label for="B_nombre_ret" class="form-label">Nombre/s</label>
								<input type="text" name="B_nombre_ret" id="B_nombre_ret" class="form-control" maxlength="50">
							</div>
							&nbsp; &nbsp;
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="B_tip_document_ret" name="B_tip_document_ret" placeholder="Tipo de Doc." maxlength="15">
									<input type="number" class="form-control" id="B_nro_document_ret" name="B_nro_document_ret" placeholder="Nro de Doc." min="0" max="999999999999999">
								</div>
							</div>

							<div class="col">
								<input type="text" name="B_vinculo_alumno" id="B_vinculo_alumno" class="form-control" placeholder="Vínculo/Parentesco con el alumno" maxlength="50">
							</div>
							</div>
							<br>
						</div>
					...
					<td>
						<div class="row">
							...
							<div class="col">
								...
								<input type="text" name="apellido_restricionjudicial" id="apellido_restricionjudicial" class="form-control" maxlength="50">
							</div>
							
							<div class="col">
								<label for="nombre_restricionjudicial" class="form-label">Nombre/s</label>
								<input type="text" name="nombre_restricionjudicial" id="nombre_restricionjudicial" class="form-control" maxlength="50">
							</div>
							&nbsp; &nbsp;
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="tip_document_restricionjudicial" name="tip_document_restricionjudicial" placeholder="Tipo de Doc." maxlength="15">
									<input type="number" class="form-control" id="nro_document_restricionjudicial" name="nro_document_restricionjudicial" placeholder="Nro de Doc." min="0" max="999999999999999">
								</div>
							</div>

							<div class="col">
								<input type="text" name="restriccion" id="restriccion" class="form-control" placeholder="Restricción">
							</div>
						</div>
						<br>
					</td>
